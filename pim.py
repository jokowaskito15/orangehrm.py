...
class TestMenuPIM(unittest.TestCase): 
    ...
    def test_a_search_blank_username_employee(self): 
        ...
        browser.find_element(By.ID,"empsearch_employee_name_empName").send_keys("") # isi employee
        browser.find_element(By.ID,"empsearch_supervisor_name").send_keys("") # isi supervisor
        browser.find_element(By.ID,"empsearch_id").send_keys("") # isi id

        Select(browser.find_element(By.ID,"empsearch_job_title")).select_by_index(32) # select job title
        Select(browser.find_element(By.ID,"empsearch_employee_status")).select_by_index(2) # select Employment Status
        Select(browser.find_element(By.ID,"empsearch_sub_unit")).select_by_index(4) # select Sub Unit
        Select(browser.find_element(By.ID,"empsearch_termination")).select_by_index(1) # select Include
        browser.find_element(By.ID,"searchBtn").click() # klik tombol search

        # validasi
        expected_current_url = "https://opensource-demo.orangehrmlive.com/index.php/pim/viewEmployeeList"
        self.assertEqual(expected_current_url,browser.current_url)

    def test_b_search_employee_name_belum_terdaftar(self): 
        # steps
        browser = self.browser #buka web browser
        browser.get("https://opensource-demo.orangehrmlive.com/") # buka situs
        browser.maximize_window()
        ...
        browser.find_element(By.ID,"menu_pim_viewPimModule").click() # klik menu pim
        browser.find_element(By.ID,"empsearch_employee_name_empName").send_keys("wkwkwkkwkk") # isi employee
        browser.find_element(By.ID,"empsearch_supervisor_name").send_keys("") # isi supervisor
        browser.find_element(By.ID,"empsearch_id").send_keys("") # isi id
        Select(browser.find_element(By.ID,"empsearch_job_title")).select_by_index(32) # select job title
        Select(browser.find_element(By.ID,"empsearch_employee_status")).select_by_index(2) # select Employment Status
    ...
    def test_c_search_supervisor_belum_terdaftar(self): 
        # steps
        browser = self.browser #buka web browser
        browser.get("https://opensource-demo.orangehrmlive.com/") # buka situs
        browser.maximize_window()
        ...
        browser.find_element(By.ID,"menu_pim_viewPimModule").click() # klik menu pim
        browser.find_element(By.ID,"empsearch_employee_name_empName").send_keys("") # isi employee
        browser.find_element(By.ID,"empsearch_supervisor_name").send_keys("awokwokwok") # isi supervisor
        browser.find_element(By.ID,"empsearch_id").send_keys("") # isi id
        Select(browser.find_element(By.ID,"empsearch_job_title")).select_by_index(32) # select job title
        Select(browser.find_element(By.ID,"empsearch_employee_status")).select_by_index(2) # select Employment Status
        Select(browser.find_element(By.ID,"empsearch_sub_unit")).select_by_index(4) # select Sub Unit
